...
#         self.load_btn = QPushButton("Load Selected Person")
...
#         self.load_btn.clicked.connect(self.load_selected_person)
...
#         self.ref_manager.person_selected.connect(self.set_selected_person)
#         self.ref_manager.show()

#     def set_selected_person(self, person_name):
#         self.selected_person = person_name
#         self.quick_mode = False
#         QMessageBox.information(
#             self,
#             "Person Selected",
#             f"Selected person:\n{person_name}\n\nClick 'Load Selected Person'"
#         )

#     def load_selected_person(self):
#         if not self.selected_person:
#             QMessageBox.warning(self, "Error", "No person selected")
#             return

#         person_db = self.encoder.encode_reference_directory(
#             REFERENCE_DIR,
#             only_person=self.selected_person
#         )

#         if self.selected_person not in person_db:
#             QMessageBox.warning(
#                 self,
#                 "Error",
#                 "No valid face images found for this person"
#             )
#             return

#         # NOTE: FaceEncoder returns MEAN embedding per person
#         self.face_finder = VideoFinder({
#             self.selected_person: person_db[self.selected_person]
#         })
...
#             QMessageBox.warning(self, "Error", "Load a person first")
#             return
...
#         label = "QUICK VERIFY" if self.quick_mode else f"PERSON: {self.selected_person}"
#         cv2.putText(
#             frame,
#             label,
#             (10, 30),
